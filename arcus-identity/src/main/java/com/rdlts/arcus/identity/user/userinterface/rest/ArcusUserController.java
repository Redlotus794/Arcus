...
public class ArcusUserController {
    ...
    @Autowired
    public ArcusUserController(@Nonnull ArcusUserApplicationService arcusUserApplicationService) {
...
//        arcusUserApplicationService.createUser(new CreateUserCommand() {
//        });
    }
